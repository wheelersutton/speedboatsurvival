PRODUCT_NAME       = SpeedBoatSurvival
SOURCES            = main.c myLib.c text.c game.c spritesheet.c OAM.c cityscape.c sky.c instructionsScreen.c instructionsScreen2.c sound.c bullet.c bgMusic.c startscreen.c pausescreen.c losescreen.c maintheme.c pausesound.c menubutton.c explosion.c highscoresscreen.c nameselectsound.c
